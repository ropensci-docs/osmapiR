...
- [`st_as_sf.osmapi_map_notes()`](https://docs.ropensci.org/osmapiR/reference/st_as_sf.md)
  [`st_as_sf.osmapi_changesets()`](https://docs.ropensci.org/osmapiR/reference/st_as_sf.md)
  [`st_as_sf.osmapi_gps_track()`](https://docs.ropensci.org/osmapiR/reference/st_as_sf.md)
  [`st_as_sf.osmapi_gpx()`](https://docs.ropensci.org/osmapiR/reference/st_as_sf.md)
...
- [`tags_list2wide()`](https://docs.ropensci.org/osmapiR/reference/tags_list-wide.md)
  ...
  Change `tags` from a list column \<-\> columns for each key in wide
  format
