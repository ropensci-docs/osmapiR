...
**WARNING**: This vignette contain examples that can edit your GPX
traces at [OpenStreetMap.org](https://www.openstreetmap.org). If you
prefer to use the [testing
server](https://master.apis.dev.openstreetmap.org), create a user there
and configure `osmapiR` to use it.
