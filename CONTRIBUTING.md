...
This outlines how to propose a change to osmapiR. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ropensci/osmapiR", fork = TRUE)`.
...
Code of Conduct](https://docs.ropensci.org/osmapiR/CODE_OF_CONDUCT.md).
